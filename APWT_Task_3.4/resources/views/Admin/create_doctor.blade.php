...
<div style="text-align:center;">
    <h4>Create Doctor</h4>
    <small>Being admin gives you to prevelige to add doctors</small>
</div><br>
<form action="{{ route('add_doctor') }}" method="post" class="row g-3" enctype="multipart/form-data">
@csrf
<div class="col-md-6">
...
<div class="col-12">
  ...
  <div class="col-12">
      <br>
    <input type="submit" value="Add Doctor" class="btn btn-primary"> <br>
